...
gpu_kernels="2" ## analoga ton arithmo exoume kai diaforetiki ekdosi kernel dld erwtima
##gpu_kernels="0 1 2" ## analoga ton arithmo exoume kai diaforetiki ekdosi kernel dld erwtima
# problem_sizes="1" # in Kibi's (x1024)
