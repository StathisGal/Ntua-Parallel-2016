...
#PBS -o dmv_gpu_kernel_3_polla_width.out
#PBS -e dmv_gpu_kernel_3_polla_width.err
#PBS -l walltime=06:00:00
#PBS -l nodes=1:ppn=24:cuda

export LD_LIBRARY_PATH=/usr/local/cuda/lib64:$LD_LIBRARY_PATH

gpu_kernels="3" ## analoga ton arithmo exoume kai diaforetiki ekdosi kernel dld erwtima
