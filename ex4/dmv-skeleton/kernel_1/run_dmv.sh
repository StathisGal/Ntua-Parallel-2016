...
## required executions for these versions.x
##
## Copyright (C) 2012, Computing Systems Laboratory (CSLab)
##

#PBS -o dmv_gpu_kernel_1_polla_width.out
#PBS -e dmv_gpu_kernel_1_polla_width.err
#PBS -l walltime=06:00:00
#PBS -l nodes=1:ppn=24:cuda

export LD_LIBRARY_PATH=/usr/local/cuda/lib64:$LD_LIBRARY_PATH

gpu_kernels="1" ## analoga ton arithmo exoume kai diaforetiki ekdosi kernel dld erwtima
...
cd /home/parallel/parlab14/ex4/dmv-skeleton/kernel_1
