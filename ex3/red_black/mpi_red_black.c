...
int main(int argc, char ** argv) {
    ...
    struct timeval tts,ttf,tcs,tcf,tcs_1,tcf_1,teps,tepf,teps_1,tepf_1;   //Timers: total-tts,ttf, computation-tcs,tcf
	...
	*/
	...
	/* Calculate Time */
	tcomp+= (tcf.tv_sec-tcs_1.tv_sec)+(tcf.tv_usec-tcs_1.tv_usec)*0.000001 + (tcf_1.tv_sec-tcs.tv_sec)+(tcf_1.tv_usec-tcs.tv_usec)*0.000001;
