...
int main(int argc, char ** argv) {
    ...
    struct timeval tts,ttf,tcs,tcf,teps,tcs_1,tcf_1,tepf,teps_1,teps_2,tepf_1,tepf_2;   //Timers: total-tts,ttf, computation-tcs,tcf
	...
	*/
    ...
    /* Calculate Time */
    tcomp+= (tcf_1.tv_sec-tcs.tv_sec)+(tcf_1.tv_usec-tcs.tv_usec)*0.000001+(tcf.tv_sec-tcs_1.tv_sec)+(tcf.tv_usec-tcs_1.tv_usec)*0.000001;
    tepic+=  (tepf.tv_sec-teps_1.tv_sec)+(tepf.tv_usec-teps_1.tv_usec)*0.000001 +    (tepf_1.tv_sec-teps.tv_sec)+(tepf_1.tv_usec-teps.tv_usec)*0.000001;    
